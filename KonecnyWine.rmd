...
ggplot(aes(y = baf_wines_w$residual.sugar, x= rating, color = rating), data = baf_wines_w)+
  ...
  scale_linetype_manual("keep wines",values=c("dashed", "dotted"),
                        guide=guide_legend(override.aes = list(colour = c("green", "blue"))))+
...
This plot shows that it is hard to reliably discriminate even between medium and excellent wines. Cases of very similar wines with very different ratings are highlighted by red backgrounds. I have tried different combinations of variables, but I couldn't find a combination which reliably discriminates between good, medium and excellent wines.
